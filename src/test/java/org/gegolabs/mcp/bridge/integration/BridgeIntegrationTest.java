...
class BridgeIntegrationTest {
    ...
    void testStaticFactoryMethod() {
        ...
        // With fixes enabled, it returns FixedBridgeTransportProvider
        if (Boolean.parseBoolean(System.getProperty("mcp.bridge.apply.fixes", "true"))) {
            assertInstanceOf(FixedBridgeTransportProvider.class, provider);
        } else {
    ...
    void testBuilderPattern() {
        ...
        // With fixes enabled, it returns FixedBridgeTransportProvider
        if (Boolean.parseBoolean(System.getProperty("mcp.bridge.apply.fixes", "true"))) {
            assertInstanceOf(FixedBridgeTransportProvider.class, bridge.getTransportProvider());
        } else {
